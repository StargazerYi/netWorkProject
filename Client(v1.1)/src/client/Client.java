...
public class Client {
    ...
    public static void main(String[] args) throws InterruptedException {
        try {
            ...
            clientSocket = (SSLSocket)factory.createSocket(Data.serverIP, 5555); 
            String[] pwdsuits = clientSocket.getSupportedCipherSuites();
            //socket可以使用所有支持的加密套件
            clientSocket.setEnabledCipherSuites(pwdsuits);
            //默认就是true
            sclientSocket.setUseClientMode(true);
