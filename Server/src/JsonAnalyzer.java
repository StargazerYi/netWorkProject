...
public class JsonAnalyzer {
     ...
     * @return a JsonObject with given values
     */
    public static JSONObject type3(String id, String[] list) {
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("Type", 3);
        map.put("UserId", id);
     ...
     * @return a JsonObject with given values
     */
    public static JSONObject type9(String userid, String username, boolean status, String[] idlist, String[] namelist) {
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("Type", 9);
        map.put("UserId", userid);
        map.put("UserName", username);
     ...
     * @return a JsonObject with given values
     */
    public static JSONObject type11(String userid, String username, String group,String[] idlist, String[] namelist) {
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("Type", 11);
        map.put("UserId", userid);
        map.put("UserName", username);
